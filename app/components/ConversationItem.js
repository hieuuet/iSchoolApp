...
import {
  Text, View, TouchableOpacity, Image, Dimensions, PureComponent
} from "react-native";
        ...
        return (
            <View style={styles.container} onPress={this.props.onPress}>
                <View style={styles.header}>
                    <Image source={{uri: data.avatar}} style={styles.ava} />
                ...
                <View style={styles.body}>
                    {data.message &&
                        <Text style={{ marginLeft: 15, marginRight: 15 }}>{data.message}</Text>
                    }
                    {data.imgPost &&
                        <Image
